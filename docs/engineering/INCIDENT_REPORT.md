...
PR #162 added a structured summary and Explain actions but introduced several data-integrity and renderer defects. This branch corrects those defects without broad extraction rewrites.
...
The confirmed summary/explain defects are corrected on `fix/solicitation-incident-complete-v2`.

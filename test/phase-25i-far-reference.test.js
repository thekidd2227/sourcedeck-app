...
test('FAR Reference section pill exists in the Phase 25F GovCon section nav', () => {
  assert.match(HTML, /href="#gc-far-reference"[^>]*onclick="gcScrollTo\(event,'gc-far-reference'\)"/);
